      ...
      <Container>
        <Row className="mt-5" id="services">
          <Col lg={{ size: 10, offset: 1 }} sm="12" className="mt-2">
            ...
            <p className="mt-3">
              John Grienauer has been an attorney practicing civil litigation primarily in Los Angeles County, California for over 40 years during which time 35 years has been spent as a sole practitioner. <strong>Currently, Mr. Grienauer's practice is focused on litigation involving disputes over title to property and disputes over leases with rental values in excess of $25,000 per month.</strong>
